...
~/anaconda3/envs/worldtaskeval/bin/python main.py --processes $SLURM_CPUS_PER_TASK --job_id $SLURM_JOB_ID --start_doc_id 262 --batch_siz 128 --config_teacher conf/ollama-qwen2.yaml --config_learner conf/ollama-qwen2.yaml --config_evaluator conf/ollama-qwen2.yaml
