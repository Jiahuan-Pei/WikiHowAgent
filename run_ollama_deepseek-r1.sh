...
~/anaconda3/envs/worldtaskeval/bin/python main.py --processes $SLURM_CPUS_PER_TASK --batch_size 32 --config_teacher conf/ollama-deepseek-r1.yaml --config_learner conf/ollama-deepseek-r1.yaml --config_evaluator conf/ollama-deepseek-r1.yaml
