...
~/anaconda3/envs/worldtaskeval/bin/python main.py --processes $SLURM_CPUS_PER_TASK --job_id $SLURM_JOB_ID --batch_size 16 --config_teacher conf/ollama-openchat.yaml --config_learner conf/ollama-deepseek.yaml --config_evaluator conf/ollama-openchat.yaml
