...
# export CUDA_VISIBLE_DEVICES=3  # Use the allocated GPU
...
~/anaconda3/envs/worldtaskeval/bin/python main.py --processes $SLURM_CPUS_PER_TASK --job_id $SLURM_JOB_ID --batch_size 4 --config_teacher conf/ollama-olmo2.yaml --config_learner conf/ollama-openchat.yaml --config_evaluator conf/ollama-olmo2.yaml
