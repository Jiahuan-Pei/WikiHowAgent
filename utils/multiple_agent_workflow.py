...
def process_method(method, method_id, summary, source_tutorial_path, methods=None):
    ...
    # Runs a teacher and learner agent concurrently for a tutorial document.
...
if __name__ == "__main__":
    ...
    config_setting_str = f'T-{config_teacher['llm']['model']}_L-{config_learner['llm']['model']}_E-{config_evaluator['llm']['model']}_{timestamp}'
